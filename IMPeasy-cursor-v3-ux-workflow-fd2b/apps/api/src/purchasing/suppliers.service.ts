...
export class SuppliersService {
  ...
  async create(payload: CreateSupplierDto): Promise<SupplierResponseDto> {
    ...
    return {
      ...
      paymentTerm: created.paymentTerm ?? null,
  ...
  async update(id: number, payload: UpdateSupplierDto): Promise<SupplierResponseDto> {
    ...
    const updated = await this.prisma.supplier.update({
      ...
      data: {
        ...
        email: payload.email,
        phone: payload.phone,
        paymentTerm: payload.paymentTerm === undefined ? undefined : payload.paymentTerm?.trim() || null,
    ...
    return {
      ...
      paymentTerm: updated.paymentTerm ?? null,
